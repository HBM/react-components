...
describe('mdc-Checkbox', () => {
  ...
  it('should not be checked by default', () => {
    const wrapper = shallow(<Checkbox onChange={() => {}} />)
    assert(!wrapper.find('.mdc-Checkbox-input').props().checked)
  })
  ...
  it('should render a disabled checkbox', () => {
    ...
    assert(wrapper.find('.mdc-Checkbox-input').props().disabled)
  })

  it('should have a default label', () => {
    const wrapper = shallow(<Checkbox onChange={() => {}} />)
    assert.equal(wrapper.find('.mdc-Checkbox-label').text(), 'Label')
  })

  it('should render a custom label', () => {
    const wrapper = shallow(<Checkbox label='custom label' onChange={() => {}} />)
    assert(wrapper.find('.mdc-Checkbox-label').text(), 'custom label')
  })

  it('should callback when clicked', (done) => {
    const change = () => done()
    const wrapper = shallow(<Checkbox onChange={change} />)
    wrapper.find('.mdc-Checkbox-input').simulate('change')
  })
})
